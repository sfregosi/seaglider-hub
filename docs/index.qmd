...
See UW/IOPs [resources](https://iop.apl.washington.edu/iopsg/){target="_blank"} page for the latest documentation from the current Seaglider manufacturer and support team. 
...
##### [Seaglider Menu Guide](sg-menu-guide.qmd)
...
[Setting up a computer for piloting](https://docs.google.com/document/d/1rqERmZ7kWoYHuO3HXz8U3ZwGJCOuNYLvX1fyqYhGiX4/edit?tab=t.0#heading=h.ze9nftrl0m84)
...
[Connecting to the OSU Basestation](https://docs.google.com/document/d/16-1I55KMxM6fWWpHIrvCdp6W2dOZZEsjzKPljDi5yeU/edit?tab=t.0#heading=h.b5vy5rp8zw4x)
